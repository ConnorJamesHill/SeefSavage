...
const socialLinks = {
    tiktok: {
        name: 'TikTok',
        url: 'https://www.tiktok.com/@seefsavage?_r=1&_t=ZP-93UebW9K0ze',
    ...
    instagram: {
        name: 'Instagram',
        url: 'https://www.instagram.com/seefsavage/',
        icon: `<svg viewBox="0 0 24 24" fill="currentColor">
    ...
    reddit: {
        name: 'Reddit',
        url: 'https://www.reddit.com/user/SeefSavage/',
        icon: `<svg viewBox="0 0 24 24" fill="currentColor">
